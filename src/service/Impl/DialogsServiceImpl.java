    ...
    public String getDialogMessagesByJson(String other, long lastMessageId, boolean getOldMessages, String cookieUser) {
        ...
        try{
            ...
            if (getOldMessages) { 
                ...
                if (lastMessageId == -1) {
                    json.put("otherAvatar", Factory.getInstance().getUserDAO().getUserByLogin(other).getAvatar());
                }
            } else {
    ...
    public String getDialogsByJson(String user, long lastMessageId, int count) {
        ...
        try{
            ...
            for (int i = 0; i < dialogs.size(); i++){
                ...
                long otherAvatar = Factory.getInstance().getUserDAO().getUserByLogin(other).getAvatar();
